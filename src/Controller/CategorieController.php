...
{
    public function __construct(private CategorieRepository $categorieRepository, private VoteService $voteService, private ManagerRegistry $managerRegistry)
    {
    }
    #[Route(path: '/', name: 'categorie_index', methods: ['GET'])]
    public function index() : Response
    {
        return $this->render('@AcMarcheMeriteSportif/categorie/index.html.twig',
            [
    ...
    public function new(Request $request) : Response
    {
        ...
        return $this->render('@AcMarcheMeriteSportif/categorie/new.html.twig',
            [
                'categorie' => $categorie,
    ...
    public function show(Categorie $categorie) : Response
    {
        ...
        return $this->render('@AcMarcheMeriteSportif/categorie/show.html.twig',
            [
                'categorie' => $categorie,
                'votes' => $votes,
            ]
    ...
    public function edit(Request $request, Categorie $categorie) : Response
    {
        ...
        return $this->render('@AcMarcheMeriteSportif/categorie/edit.html.twig',
            [
                'categorie' => $categorie,
                'form' => $form->createView(),
            ]
