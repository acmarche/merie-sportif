...
class DefaultController extends AbstractController
{
    ...
    {
        return $this->render('@AcMarcheMeriteSportif/default/index.html.twig',
            [
    ...
    {
        return $this->render('@AcMarcheMeriteSportif/default/contact.html.twig',
            [
    ...
    public function resultat() : Response
    {
        ...
        return $this->render('@AcMarcheMeriteSportif/default/resultat.html.twig',
            [
                'votes' => $votes,
            ]
        );
